...
export default function Rewards() {
  ...
  const storeItems = [
    { brand: "Mint Basil Market", offer: "20% Off Organic Foods", coins: 500, color: "from-green-900 to-green-950", logo: "https://shopmintandbasil.com/cdn/shop/files/M_B-Logo-squiggle-PNG.png?v=1673297210&width=153", progress: 100, featured: true },
    { brand: "Class Sport", offer: "$50 Store Voucher", coins: 1200, color: "from-blue-900 to-blue-950", logo: "https://scontent.fbey4-2.fna.fbcdn.net/v/t39.30808-1/310631696_468809508623180_5220337573563246166_n.png?stp=dst-png_s200x200&_nc_cat=100&ccb=1-7&_nc_sid=2d3e12&_nc_ohc=vMjEHrXPp6AQ7kNvwGKVKaw&_nc_oc=AdrB1wHZE3AbkZLEiD5V1SDqvbDdTYo08HMSiKZaaEpk32HFQ4ncqAg4wDzajz8QGVs&_nc_zt=24&_nc_ht=scontent.fbey4-2.fna&_nc_gid=yPJPrVw__6yanFmNLGlFSg&_nc_ss=7a30f&oh=00_AfwYPRzB2kZWsHkIDWCeLQKIwIBt1viRZWnAHMcRjoTVbw&oe=69C273B7", progress: 75 },
    { brand: "Wesley's Wholesale", offer: "Free Protein Bar Box", coins: 800, color: "from-orange-900 to-orange-950", logo: "https://s2.googleusercontent.com/s2/favicons?domain=wesleyswholesale.com&sz=128", progress: 40 },
    { brand: "Step Ahead", offer: "Free Month Pass", coins: 2500, color: "from-zinc-800 to-zinc-950", logo: "https://s2.googleusercontent.com/s2/favicons?domain=stepaheadsports.com&sz=128", progress: 100 },
    { brand: "Decathlon Lebanon", offer: "Running Gear Discount", coins: 900, color: "from-sky-900 to-sky-950", logo: "https://s2.googleusercontent.com/s2/favicons?domain=decathlon.com.lb&sz=128", progress: 100, featured: true },
    { brand: "Goodies", offer: "Healthy Snack Bundle", coins: 600, color: "from-red-900 to-red-950", logo: "https://s2.googleusercontent.com/s2/favicons?domain=goodies.com.lb&sz=128", progress: 85 },
    ...
    { brand: "Barbell House", offer: "Free Personal Training", coins: 3000, color: "from-neutral-800 to-neutral-900", logo: "https://s2.googleusercontent.com/s2/favicons?domain=barbellhouse.com&sz=128", progress: 100 }
  ];
    ...
    <div className="relative px-6 pb-24 pt-16 overflow-hidden font-['Poppins'] min-h-[80vh]">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeInUp} className="max-w-5xl mx-auto mb-32">
          <div className="bg-[#050505] border border-[#222] rounded-[3rem] p-8 md:p-16 flex flex-col md:flex-row items-center gap-12 relative overflow-hidden shadow-2xl">
             ...
             <div className="md:w-1/2 flex justify-center relative z-10 w-full">
               <div className="relative w-64 h-64 flex items-center justify-center group">
                 ...
                 {/* 3D Coin Core */}
                 <div className="w-40 h-40 bg-gradient-to-br from-yellow-300 via-yellow-500 to-yellow-700 rounded-full flex items-center justify-center shadow-[inset_0_-10px_20px_rgba(0,0,0,0.4),0_10px_30px_rgba(234,179,8,0.3)] relative z-10 group-hover:scale-105 transition-transform duration-500">
                   <div className="w-32 h-32 rounded-full border-2 border-yellow-300/50 flex items-center justify-center bg-gradient-to-tl from-yellow-600 to-yellow-400">
                     <svg className="w-16 h-16 text-yellow-100 drop-shadow-md" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>
                   </div>
                 </div>
               </div>
             </div>
        ...
        <motion.div variants={staggerContainer} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-32">
          {[
            ...
            <motion.div key={idx} variants={fadeInUp} className="h-full">
              <Card className="bg-[#111] border border-[#222] p-8 h-full rounded-[2rem] hover:border-yellow-500/30 transition-colors flex flex-col group relative overflow-hidden">
        ...
        {/* The Store Preview */}
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeInUp} className="mb-32 max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-end mb-12 border-b border-white/10 pb-6 gap-6">
            <div>
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-black uppercase tracking-tight text-white mb-2">Health & Lifestyle <span className="text-gray-500">Store.</span></h2>
                ...
                <div className="relative z-10 flex flex-col h-full">
                  ...
                  <div className="flex justify-between items-start mb-6">
                    <div className="w-16 h-16 rounded-2xl bg-white flex items-center justify-center p-2 shadow-sm overflow-hidden border border-[#222] group-hover:scale-110 transition-transform duration-500 shrink-0">
                      <img src={item.logo} alt={item.brand} className="w-full h-full object-contain" onError={(e) => { e.currentTarget.style.display = 'none'; e.currentTarget.nextSibling.style.display = 'flex'; }} />
