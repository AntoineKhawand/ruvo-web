...
export default function Layout() {
    ...
    useEffect(() => {
        ...
        // Sync Lenis RAF with GSAP ticker for zero-stutter ScrollTrigger
        ...
        // Drive the scroll-to-top button visibility via Lenis
    ...
    useEffect(() => {
        setIsLoaded(true);
        // Instant scroll reset on route change — no jump, respects Lenis
    ...
    const handleNewsletterSubscribe = (e) => {
        e.preventDefault();
        setNewsletterFormStatus("submitting");
        // Simulate API call
        setTimeout(() => {
            setNewsletterFormStatus("success");
            setNewsletterEmail(""); // Clear email field after successful subscription
        }, 1500);
    };
            ...
            <Navbar isBlurred isMenuOpen={isMenuOpen} onMenuOpenChange={setIsMenuOpen} className="bg-[#050505]/80 border-b border-white/10 backdrop-blur-2xl fixed w-full top-0 py-2 z-50">
                ...
                <NavbarBrand className="justify-center lg:justify-start">
                    <Link to="/" className="flex items-center gap-3">
                        <img src="/Ruvo Logo Original.png" alt="Ruvo Logo" width="144" height="36" className="h-8 sm:h-9" />
                    </Link>
                </NavbarBrand>
                    ...
                    <Button as={Link} to="/waitlist" radius="full" className="hidden sm:flex bg-gradient-to-r from-[#dfff00] to-lime-400 text-black font-bold px-8 shadow-[0_0_20px_rgba(223,255,0,0.3)] hover:scale-105 transition-transform">
                            Get the App
                        </Button>
                    </NavbarContent>
                <NavbarMenu className="bg-[#050505]/95 backdrop-blur-3xl border-t border-white/10 pt-8 gap-6 z-50">
                    ...
                    <NavbarMenuItem className="mt-4"><Button as={Link} to="/waitlist" radius="full" size="lg" className="w-full bg-gradient-to-r from-[#dfff00] to-lime-400 text-black font-bold">Get the App</Button></NavbarMenuItem>
                </NavbarMenu>
                </Navbar>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-12 lg:gap-8 mb-20">
                            <div className="lg:col-span-2">
                                <div className="flex items-center gap-3 mb-6">
                                    <img src="/Ruvo Logo Original.png" alt="Ruvo Logo" width="256" height="64" className="h-16" />
                                </div>
                                ...
                                <div className="flex flex-col sm:flex-row gap-3">
                                    <Button as={Link} to="/waitlist" radius="full" className="bg-white/5 text-white font-bold border border-white/10 hover:bg-white/10 hover:border-white/30 px-6 transition-all w-fit">
                            ...
                            <div className="col-span-1">
                                <h3 className="text-white font-bold mb-6 text-sm uppercase tracking-widest">Features</h3>
                            ...
                            <div className="col-span-1">
                                ...
                                <ul className="space-y-4 text-sm text-gray-500 font-medium">
                                    ...
                                    <li><Link to="/blog" className="hover:text-[#dfff00] transition-colors">Blog</Link></li>
                                </ul>
                            </div>
                            <div className="col-span-1">
                            ...
                            <div className="col-span-1">
                                <h3 className="text-white font-bold mb-6 text-sm uppercase tracking-widest">Follow us</h3>
                                <div className="flex gap-4">
                                    <a href="#" className="hidden w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-gray-400 hover:bg-[#dfff00] hover:text-black hover:border-[#dfff00] transition-all shadow-lg" aria-label="Facebook">
                                    ...
                                    <a href="#" className="hidden w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-gray-400 hover:bg-[#dfff00] hover:text-black hover:border-[#dfff00] transition-all shadow-lg" aria-label="LinkedIn">
                                        <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                            <path fillRule="evenodd" d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" clipRule="evenodd" />
                                        </svg>
                                    </a>
                                    <a href="https://www.instagram.com/ruvoapp/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-gray-400 hover:bg-gradient-to-tr hover:from-pink-500 hover:via-red-500 hover:to-yellow-400 hover:text-white hover:border-transparent transition-all shadow-lg" aria-label="Instagram">
