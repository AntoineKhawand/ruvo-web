  ...
  return (
    <div className="border-b border-white/10">
      ...
      >
        ...
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={`shrink-0 w-5 h-5 text-gray-400 transition-transform duration-300 ${open ? "rotate-180 text-[#dfff00]" : ""}`}>
...
export default function App() {
  ...
  const { isOpen: isEliteOpen, onOpen: onEliteOpen, onOpenChange: onEliteOpenChange } = useDisclosure();
    ...
    <>
      ...
      <div className="min-h-screen bg-[#050505] text-white font-['Poppins'] overflow-x-hidden selection:bg-[#dfff00] selection:text-black">
        ...
        <section className="relative min-h-screen flex flex-col items-center justify-center text-center px-6 overflow-hidden pt-24 pb-12">
          ...
          <motion.div initial="hidden" animate="visible" variants={fadeInUp} className="relative z-20 max-w-5xl mx-auto flex flex-col items-center w-full">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center w-full max-w-md mx-auto mb-16">
              <Button radius="full" size="lg" className="bg-white text-black font-bold px-10 py-8 text-base hover:scale-105 transition-transform flex items-center gap-4 w-full sm:w-auto">
              ...
              <Button radius="full" size="lg" variant="bordered" className="text-white border-white/20 backdrop-blur-md font-bold px-10 py-8 text-base hover:bg-white/10 transition-colors flex items-center gap-4 w-full sm:w-auto">
            ...
            <div className="mt-8 opacity-50 flex flex-col items-center gap-2">
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="mb-20 flex flex-col md:flex-row justify-between items-end gap-8">
              <div className="max-w-3xl">
                ...
                className="text-4xl sm:text-5xl md:text-7xl font-black text-white uppercase tracking-tighter leading-[0.9] mb-6"
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
              {featuresList.map((feature, idx) => {
                ...
                return (
                  <motion.div key={idx} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={fadeInUp} transition={{ delay: idx * 0.1 }} className="group h-full">
                  ...
                  <motion.div key={idx} variants={fadeInUp} className="h-full">
                    <Card className="bg-[#111111] border border-[#222] p-6 h-full hover:border-[#dfff00]/40 transition-all duration-500 cursor-pointer group flex flex-col rounded-3xl hover:-translate-y-2 hover:shadow-[0_10px_40px_-10px_rgba(223,255,0,0.1)]">
                      <div className="flex-grow">
                        ...
                        <h4 className="text-xl font-bold text-white mb-3 group-hover:text-[#dfff00] transition-colors">{plan.title}</h4>
        ...
        <section id="dashboard" className="relative z-10 py-32 max-w-7xl mx-auto px-6 border-t border-white/10">
          ...
          <motion.div variants={staggerContainer} initial="hidden" whileInView="visible" viewport={{ once: true }} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <motion.div variants={fadeInUp} className="lg:col-span-1 h-full">
              <Card className="bg-[#111111] border border-[#222] p-6 md:p-8 h-full flex flex-col justify-between rounded-3xl hover:border-red-500/40 transition-colors duration-700">
                ...
                {/* Vertical Pill Chart */}
                <div className="flex justify-between items-end h-32 mt-6 mb-4 px-1 border-b border-[#222] pb-4">
                  <div className="flex flex-col items-center gap-1.5 h-full justify-end">
                    <motion.div className="w-6 bg-gradient-to-t from-red-400 to-red-500 rounded-full" initial={{ height: 0 }} whileInView={{ height: '60%' }} transition={{ duration: 1, ease: "easeOut" }}></motion.div>
                    <span className="text-[10px] text-gray-500 font-bold">Mo</span>
                  </div>
                  <div className="flex flex-col items-center gap-1.5 h-full justify-end">
                    <motion.div className="w-6 bg-gradient-to-t from-red-400 to-red-500 rounded-full" initial={{ height: 0 }} whileInView={{ height: '90%' }} transition={{ duration: 1, ease: "easeOut", delay: 0.1 }}></motion.div>
                    <span className="text-[10px] text-gray-500 font-bold">Tu</span>
                  </div>
                  <div className="flex flex-col items-center gap-1.5 h-full justify-end">
                    <div className="w-6 h-6 bg-red-500 rounded-full"></div>
                    <motion.div className="w-6 bg-gradient-to-t from-red-400 to-red-500 rounded-full" initial={{ height: 0 }} whileInView={{ height: '30%' }} transition={{ duration: 1, ease: "easeOut", delay: 0.2 }}></motion.div>
                    <span className="text-[10px] text-gray-500 font-bold">We</span>
                  </div>
                  <div className="flex flex-col items-center gap-1.5 h-full justify-end">
                    <motion.div className="w-6 bg-gradient-to-t from-red-400 to-red-500 rounded-full" initial={{ height: 0 }} whileInView={{ height: '40%' }} transition={{ duration: 1, ease: "easeOut", delay: 0.3 }}></motion.div>
                    <div className="w-6 h-6 bg-red-500 rounded-full"></div>
                    <span className="text-[10px] text-gray-500 font-bold">Th</span>
                  </div>
                  <div className="flex flex-col items-center gap-1.5 h-full justify-end">
                    <motion.div className="w-6 bg-gradient-to-t from-red-400 to-red-500 rounded-full" initial={{ height: 0 }} whileInView={{ height: '50%' }} transition={{ duration: 1, ease: "easeOut", delay: 0.4 }}></motion.div>
                    <span className="text-[10px] text-gray-500 font-bold">Fr</span>
                  </div>
                  <div className="flex flex-col items-center gap-1.5 h-full justify-end">
                    <div className="w-6 h-6 bg-red-500 rounded-full"></div>
                    <motion.div className="w-6 bg-gradient-to-t from-red-400 to-red-500 rounded-full" initial={{ height: 0 }} whileInView={{ height: '60%' }} transition={{ duration: 1, ease: "easeOut", delay: 0.5 }}></motion.div>
                    <span className="text-[10px] text-gray-500 font-bold">Sa</span>
                  </div>
                  <div className="flex flex-col items-center gap-1.5 h-full justify-end">
                    <motion.div className="w-6 bg-gradient-to-t from-red-400 to-red-500 rounded-full" initial={{ height: 0 }} whileInView={{ height: '75%' }} transition={{ duration: 1, ease: "easeOut", delay: 0.6 }}></motion.div>
              ...
              <Card className="bg-[#111111] border border-[#222] h-full flex flex-col rounded-3xl hover:border-[#2dd4bf]/40 transition-colors duration-700 overflow-hidden relative group/shoe">
                ...
                <div className="p-6 flex flex-col h-full relative z-10">
                  ...
                  <div className="flex justify-between items-start w-full mb-2">
                    <div>
                      <h3 className="text-[10px] text-[#2dd4bf] font-bold uppercase tracking-widest mb-1">Your Gear</h3>
                      <h2 className="text-xl font-bold text-white">Running Shoes</h2>
                    </div>
                  </div>
          ...
          <motion.div variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true }} className="mt-16 flex justify-center w-full">
            <Button onPress={onEliteOpen} radius="full" size="lg" className="bg-transparent border-2 border-[#dfff00] text-[#dfff00] font-bold px-12 py-8 text-lg hover:bg-[#dfff00] hover:text-black transition-all duration-300 shadow-[0_0_20px_rgba(223,255,0,0.1)] hover:shadow-[0_0_40px_rgba(223,255,0,0.4)]">
        ...
        <section id="challenges" className="relative z-10 py-32 max-w-7xl mx-auto px-6 border-t border-white/10">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeInUp} className="flex flex-col lg:flex-row justify-between items-end mb-16">
        ...
        {/* 2. Elite Features Modal */}
        <Modal backdrop="blur" isOpen={isEliteOpen} onOpenChange={onEliteOpenChange} placement="center" classNames={{ base: "bg-[#111] border border-[#dfff00]/30 text-white shadow-[0_0_40px_rgba(223,255,0,0.15)]" }}>
          <ModalContent>
            {(onClose) => (
              <>
                <ModalHeader className="flex flex-col gap-1 text-[#dfff00] text-2xl font-black uppercase tracking-tight">RUVO Elite</ModalHeader>
                <ModalBody>
                  <p className="text-gray-300 font-medium leading-relaxed">
                    Unlock professional-grade diagnostics, live AI coaching, and unlimited custom training plans.
                  </p>
                  <ul className="space-y-3 mt-4 text-sm text-gray-400">
                    <li className="flex items-center gap-3"><svg className="w-5 h-5 text-[#dfff00]" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" /></svg> Real-time VO2 Max tracking</li>
                    <li className="flex items-center gap-3"><svg className="w-5 h-5 text-[#dfff00]" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" /></svg> Advanced running dynamics</li>
                    <li className="flex items-center gap-3"><svg className="w-5 h-5 text-[#dfff00]" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" /></svg> Export workouts to Garmin/Coros</li>
                  </ul>
                  <div className="bg-[#222] p-4 rounded-xl mt-4 flex items-center justify-between">
                    <div>
                      <p className="text-white font-bold">$9.99<span className="text-xs text-gray-500 font-normal"> / month</span></p>
                      <p className="text-xs text-[#dfff00]">7 days free trial</p>
                    </div>
                  </div>
                </ModalBody>
                <ModalFooter>
                  <Button variant="light" className="text-white" onPress={onClose}>Maybe Later</Button>
                  <Button className="bg-[#dfff00] text-black font-bold w-full" onPress={onClose}>Start Free Trial</Button>
                </ModalFooter>
              </>
            )}
          </ModalContent>
