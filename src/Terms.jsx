        ...
        <div className="flex flex-col lg:flex-row gap-16">
          ...
          <motion.div initial="hidden" animate="visible" variants={fadeInUp} className="flex-grow max-w-3xl prose prose-invert font-['Poppins'] max-w-none text-gray-300 leading-relaxed space-y-8 md:space-y-12 text-base md:text-lg">
            ...
            <div id={slugify(sections[7])} className="scroll-mt-32">
              <h2 className="text-2xl md:text-3xl font-black text-white mb-4 md:mb-6 tracking-tight border-t border-white/10 pt-8 md:pt-12">{sections[7]}</h2>
            ...
            <div id={slugify(sections[8])} className="scroll-mt-32">
              <h2 className="text-2xl md:text-3xl font-black text-white mb-4 md:mb-6 tracking-tight border-t border-white/10 pt-8 md:pt-12">{sections[8]}</h2>
              <p>If you have any questions or concerns about these Terms, please contact our legal team.</p>
              <Button as="a" href="mailto:legal@ruvo.run" radius="full" className="bg-white/10 text-white font-bold border border-white/20 hover:bg-white/20 mt-4 px-8">
                Contact Legal Team
              </Button>
            </div>
